/**************************************************************************//**
 * @file     core_cm1.h
 * @brief    CMSIS Cortex-M1 App Peripheral Access Layer Header File
 * @version  V1.0.1
...
#define __CORTEX_M                (1U)                                   /*!< Cortex-M App */
...
/**
  ...
  \brief    Cortex-M1 App Debug Registers (DCB registers, SHCSR, and DFSR) are only accessible over DAP and not via processor.
