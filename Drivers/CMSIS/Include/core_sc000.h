/**************************************************************************//**
 * @file     core_sc000.h
 * @brief    CMSIS SC000 App Peripheral Access Layer Header File
 * @version  V5.0.6
...
/**
  ...
  \brief    SC000 App Debug Registers (DCB registers, SHCSR, and DFSR) are only accessible over DAP and not via processor.
